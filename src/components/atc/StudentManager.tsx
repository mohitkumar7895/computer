        ...
        {tab === "add" && (
          <form onSubmit={handleAddSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div><label className={labelCls}>Mobile Number *</label><input required name="mobile" className={inputCls} placeholder="10-digit mobile" maxLength={10} /></div>
              ...
              <div><label className={labelCls}>Qualification *</label><input required name="qualification" className={inputCls} placeholder="e.g. 10th, 12th, Graduate" /></div>
              
              <div className="md:col-span-3"><label className={labelCls}>Full Address *</label><textarea required name="address" rows={2} className={inputCls} placeholder="Complete postal address" /></div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-4 border-t border-slate-100">
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50">
                <label className={labelCls}>Student Photo (Optional)</label>
                <input type="file" name="photo" accept="image/*" className="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100 cursor-pointer" />
              </div>
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50">
                <label className={labelCls}>Aadhar / ID Proof (Optional)</label>
                <input type="file" name="idProof" accept="image/*,application/pdf" className="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer" />
              </div>
            </div>
